...
public class HiFi {
    ...
    /**
     * It is possible to use different types of aggregables for construction of features and for construction
    ...
    /**
     * Sets the maximum number of aggregation-variables which can appear in a block - this
     * may be helpful in that it allows reducing the space of possible features.
     * 
