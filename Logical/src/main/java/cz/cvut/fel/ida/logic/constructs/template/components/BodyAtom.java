...
public class BodyAtom extends Atom {
    ...
    public Transformation softNegation;
     ...
     */
    public BodyAtom(WeightedPredicate weightedPredicate, List<Term> terms, boolean hardNegation, Transformation softNegation, Weight weight) {
    ...
    public Transformation getNegationActivation() {
        return softNegation;
    }

    public void setNegationActivation(Transformation softNegation){
        this.softNegation = softNegation;
    }
