...
import cz.cvut.fel.ida.pipelines.networks.computation.iteration.visitors.neurons.NeuronVisitor;
import cz.cvut.fel.ida.pipelines.networks.computation.iteration.visitors.states.StateVisiting;
import cz.cvut.fel.ida.pipelines.networks.structure.components.NeuralNetwork;
import cz.cvut.fel.ida.pipelines.networks.structure.components.neurons.BaseNeuron;
import cz.cvut.fel.ida.pipelines.networks.structure.components.neurons.Neurons;
import cz.cvut.fel.ida.pipelines.networks.structure.components.neurons.WeightedNeuron;
