...
import cz.cvut.fel.ida.pipelines.math.Sugar;
import cz.cvut.fel.ida.pipelines.math.collections.MultiMap;
import cz.cvut.fel.ida.pipelines.math.tuples.Pair;
...
public class HerbrandModelTest {
    ...
    public void testSubstitutionSpeedOLD() {
        ...
        utils.generic.Pair<Term[], List<Term[]>> groundingSubstitutions = testData.getGroundingSubstitutions();
    ...
    private class CreateTestData {
        ...
        private utils.generic.Pair<Term[], List<Term[]>> groundingSubstitutions;

        public HornClause getFinalRule() {
            return finalRule;
        }

        public utils.generic.Pair<Term[], List<Term[]>> getGroundingSubstitutions() {
