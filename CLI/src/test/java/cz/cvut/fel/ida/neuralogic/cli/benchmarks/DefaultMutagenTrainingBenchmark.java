...
public class DefaultMutagenTrainingBenchmark {
    ...
    public static class Default {
        ...
        public void testMutagenFastEnough() throws RunnerException {
            Duration referenceTime = Duration.ofMinutes(4);
        ...
        public static Pair<String, Pair<NeuralModel, Progress>> neuralTraining(Default.DefaultBenchmarkState state, Settings settings) throws Exception {
