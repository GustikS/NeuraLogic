...
public class ErrorFunctions {
    ...
    public void baseCrossentropy() throws Exception {
        ...
        assertEquals(0.4913825870258262, error, 0.000000000001);   //a converged value, so it moves whenever the default initializer does - what the two tests assert is that they agree with each other
