...
public class CrossSumDown extends NeuronVisitor.Weighted {


    public CrossSumDown(NeuralNetwork<State.Structure> network, StateVisiting.Computation computationVisitor, WeightUpdater weightUpdater) {
    ...
    public <T extends Neurons, S extends State.Neural> void visit(BaseNeuron<T, S> neuron) {
        ...
        int[][] mapping = ((CombinationState.CrossSumState) state.getFcnState()).mapping;  //todo make this brutal exploitation somewhat nicer
